    ...
    <section id="senior-profile" className="relative">
      <div className="">
        <div className="flex flex-wrap items-center gap-5">
          <div className="w-full grid gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            <div className="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark">
              <div className="invisible">

                <svg width="58" height="58" viewBox="0 0 58 58" fill="none">
                  <circle cx="29" cy="29" r="29" fill="#3FD97F"></circle>
                  <path
                ...
                <div className="mt-6 flex items-end justify-between">
                  <dl>
                    ...
                    <dd className="text-sm font-medium text-dark-6">Total Views</dd>
                  </dl>
                  <dl className="text-sm font-medium text-green">
                    ...
                    <dd className="sr-only">Total Views Increased by 0.43%</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="invisible">
                ...
                <div className="mt-6 flex items-end justify-between">
                  <dl>
                    ...
                    <dd className="text-sm font-medium text-dark-6">Total Profit</dd>
                  </dl>
                  <dl className="text-sm font-medium text-green">
                    <dt className="flex items-center gap-1.5">
                      4.35%
                    ...
                    <dd className="sr-only">Total Profit Increased by 4.35%</dd>
                  </dl>
                </div>
              </div>
            </div>
            <div className="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark">
              <div className="invisible">
                ...
                <svg width="58" height="58" viewBox="0 0 58 58" fill="none">
                  <circle cx="29" cy="29" r="29" fill="#8155FF"></circle>
                  <path
                ...
                <div className="mt-6 flex items-end justify-between">
                  <dl>
                    ...
                    <dd className="text-sm font-medium text-dark-6">Total Products</dd>
                  </dl>
                  <dl className="text-sm font-medium text-green">
                    <dt className="flex items-center gap-1.5">
                      2.59%
            ...
            <div className="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark">
              <div className="invisible">
                ...
                <svg width="58" height="58" viewBox="0 0 58 58" fill="none">
                  <circle cx="29" cy="29" r="29" fill="#18BFFF"></circle>
                  <ellipse
                    cx="25.7511"
                    cy="22.4998"
                    rx="4.33333"
                ...
                <div className="mt-6 flex items-end justify-between">
                  <dl>
                    ...
                    <dd className="text-sm font-medium text-dark-6">Total Users</dd>
                  </dl>
                  <dl className="text-sm font-medium text-red">
                    <dt className="flex items-center gap-1.5">
                      -0.95%
                      <svg
                        width="10"
                    ...
                    <dd className="sr-only">Total Users Decreased by -0.95%</dd>
                  </dl>
                </div>
              </div>
            </div>
