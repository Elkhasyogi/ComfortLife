...
const Breadcrumb = ({
  ...
  return (
    <>
      <div className="dark:bg-dark relative z-10 overflow-hidden pb-[30px] pt-[90px] md:pt-[90px] lg:pt-[90px]">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div className="text-center">
                <h1 className="text-dark mb-4 font-bold dark:text-white md:leading-[1.2]">
                  {pageName}
                </h1>
